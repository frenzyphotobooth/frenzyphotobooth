...
- `js/lib/slider.js`: reusable slider behavior (dots/arrows/autoplay/media-pause).
...
1. `js/lib/slider.js`
2. `js/features/home-video.js`
3. `js/features/ui/theme.js`
4. `js/features/ui/navbar-scroll.js`
5. `js/features/ui/mobile-menu.js`
6. `js/features/ui.js`
7. `js/features/animations/counters.js`
8. `js/features/animations/scroll-reveal.js`
9. `js/features/animations/particles.js`
10. `js/features/animations/smooth-scroll.js`
11. `js/features/animations.js`
12. `js/features/testimonials.js`
13. `js/features/video-showcase.js`
14. `js/features/contact/form-validation.js`
15. `js/features/contact/form-ui.js`
16. `js/features/contact/form-submission.js`
17. `js/features/booking-form.js`
18. `js/core/main.js`
